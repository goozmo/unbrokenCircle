...
<?php if ($redux_demo['archive_events_header_img_display'] == 1){ ?>

	<section id="nicdark_archive_parallax" class="nicdark_section nicdark_imgparallax" style="background:url(<?php echo esc_url( $redux_demo['archive_events_header_img']['url'] ); ?>) 50% 0 fixed; background-size:cover;">

	    <div class="nicdark_filter <?php echo $redux_demo['archive_events_header_filter']; ?>">

	        <!--start nicdark_container-->
	        <div class="nicdark_container nicdark_clearfix">

	            <div class="grid grid_12">
	                <div class="nicdark_space<?php echo $redux_demo['archive_events_header_margintop']; ?>"></div>
	                <h1 class="white subtitle"><?php echo $redux_demo['archive_events_header_title']; ?></h1>
	                <div class="nicdark_space20"></div>
	                <div class="nicdark_divider left big"><span class="nicdark_bg_white nicdark_radius"></span></div>
	                <div class="nicdark_space<?php echo $redux_demo['archive_events_header_marginbottom']; ?>"></div>
	            </div>
...
if ( $advsearch == 'true' ) { 
	...
	if ( $date == '' ) { 
		...
		$args = array(
		  ...
		  'nopaging' => 'true',
		  ''.$taxonomy.'' => ''.$term.'',
		  'meta_query' => array( array( 'key' => 'metabox_event_date', 'value' => ''.$date.'' ))
		);
	        ...
	        <div class="nicdark_masonry_container">
				...
				<?php
					while ( $the_query->have_posts() ) : $the_query->the_post();
						...
						include 'include/event/archive-preview-event.php';
        ...
        <div class="nicdark_masonry_container">
    		...
    		<?php if(have_posts()) : ?>
				...
				<?php while(have_posts()) : the_post(); ?>
					...
					<?php include 'include/event/archive-preview-event.php'; ?>
