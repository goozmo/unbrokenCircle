...
$imgsrc = wp_get_attachment_image_src($srcparallax,'large');
...
$script = ( $imgparallax == 'yes' ) ? ' <script type="text/javascript">(function($) { "use strict"; $("#'.$idparallax.'").parallax("50%", 0.3); })(jQuery);</script> ' : '';
