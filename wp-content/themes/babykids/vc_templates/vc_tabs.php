...
foreach ( $tab_titles as $tab ) {
	...
	if(isset($tab_atts['title'])) {
		$tabs_nav .= '<li class=" '.$tab_atts['customclass'].' "><a class="title white nicdark_bg_'.$tab_atts['bgcolor'].' " href="#tab-' . ( isset( $tab_atts['tab_id'] ) ? $tab_atts['tab_id'] : sanitize_title( $tab_atts['title'] ) ) . '"><i class="'.$tab_atts['icon'].'"></i>' . $tab_atts['title'] . '</a></li>';
	}
}
$tabs_nav .= '</ul>' . "\n";
