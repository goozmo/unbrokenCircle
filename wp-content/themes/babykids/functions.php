...
function nicdark_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/revslider.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com//themes/baby-kids/wp/plugins/contact-form-7.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/wordpress-importer.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/js_composer.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/nicdark-shortcodes.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/timetable-1.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/woocommerce.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
