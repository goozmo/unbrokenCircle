   ...
   vc_map( array(
      ...
      "params" => array(
         ...
         array(
            ...
            "param_name" => "role",
            'admin_label' => true,
            "value" => __( "Music Teacher", "nicdark-shortcodes" ),
         ...
         array(
            ...
            "param_name" => "icon",
            "value" => __( "icon-music-outline", "nicdark-shortcodes" ),
         ...
         array(
            ...
            "value" => __( "Insert the desciption of the team member", "nicdark-shortcodes" ),
         ...
         array(
            ...
            "param_name" => "icon1",
            "value" => __( "icon-download-outline", "nicdark-shortcodes" ),
            'description' => __( "Insert icon code e.g. icon-diamond <a target='_blank' href='http://www.nicdarkthemes.com/themes/baby-kids/html/demo/icons.php'>see all icons</a>", "nicdark-shortcodes" ),
         ...
         array(
            ...
            "param_name" => "icon2",
            "value" => __( "icon-attach-outline", "nicdark-shortcodes" ),
            'description' => __( "Insert icon code e.g. icon-diamond <a target='_blank' href='http://www.nicdarkthemes.com/themes/baby-kids/html/demo/icons.php'>see all icons</a>", "nicdark-shortcodes" ),
            'dependency' => array( 'element' => 'icons', 'value' => array( 'yes' ) )
         ),
         array(
         ...
         array(
            ...
            "param_name" => "icon3",
            "value" => __( "icon-mic-outline", "nicdark-shortcodes" ),
            'description' => __( "Insert icon code e.g. icon-diamond <a target='_blank' href='http://www.nicdarkthemes.com/themes/baby-kids/html/demo/icons.php'>see all icons</a>", "nicdark-shortcodes" ),
            'dependency' => array( 'element' => 'icons', 'value' => array( 'yes' ) )
         ),
         array(
