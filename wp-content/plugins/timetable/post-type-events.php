...
function timetable_events_init()
{
	...
	$labels = array(
		...
		'parent_item_colon' => '',
		'menu_name' => __("Time Table Posts", 'timetable')
	);
	$args = array(  
		"labels" => $labels, 
		"public" => true,  
	...
	register_taxonomy("events_category", array("events"), array("label" => "Categories", "singular_label" => "Category", "rewrite" => true, "hierarchical" => true));
