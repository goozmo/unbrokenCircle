		...
		setTimeout(function(){
			...
			for(var i=0; i<attributes.length; i++)
			{
				...
				if(attributes[i].indexOf('direction=')!=-1)
					direction = attributes[i].replace('direction=', '').replace(/\'/g, "");
